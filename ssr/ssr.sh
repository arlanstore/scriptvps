...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/arlanstoreperizinan/main/ipvps.txt | grep $MYIP )
if [ $MYIP = $IZIN ]; then
...
# Link Hosting Kalian
akbarvpn="raw.githubusercontent.com/arlanstore/scriptvps/main/ssr"
